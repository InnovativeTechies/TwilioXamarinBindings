...
namespace Twilio.Video.iOS
{
    ...
    internal interface ITVIAudioDeviceCapturer
    {
    }

    internal interface ITVIAudioDeviceRenderer
    {
    }
    ...
    interface TVIAudioSink
    {
        ...
        [Abstract]
        [Export("renderSample:")]
        unsafe void RenderSample(CoreMedia.CMSampleBuffer audioSample);
    }
    ...
    interface TVILocalVideoTrack
    {
        ...
        // +(instancetype _Nullable)trackWithCapturer:(id<TVIVideoCapturer> _Nonnull)capturer enabled:(BOOL)enabled constraints:(TVIVideoConstraints * _Nullable)constraints name:(NSString * _Nullable)name;
        [Static]
        [Export("trackWithCapturer:enabled:constraints:name:")]
        [return: NullAllowed]
        TVILocalVideoTrack TrackWithCapturer(ITVIVideoCapturer capturer, bool enabled, [NullAllowed] TVIVideoConstraints constraints, [NullAllowed] string name);
    }
